<template>
    <div>
      ...
      <el-dialog
        ...
        width="50%">
        <add-detail :goods-all-data="dataOptions" ref="saveDetail" :form-data="detailData" :data-options-company="dataOptionsCompany" :type="2" />
      ...
      <el-dialog
        ...
        width="50%">
        <add-detail :goods-all-data="dataOptions" ref="saveDetail" :form-data="updateData" :data-options-company="dataOptionsCompany" :type="2" />
        <span slot="footer" class="dialog-footer">
          <el-button @click="showAddDialog = false">取 消</el-button>
